...
if [ ! -d "${PACKAGE_DIR}/GIMP.app/Contents/Resources/Library/Frameworks/Python.framework/Versions/2.7/Resources/Python.app/Contents/Resources" ]; then
  # Avoids creating very awkward link in the wrong place
  echo "***Error: Python framework not found"
  exit 1
fi
pushd "${PACKAGE_DIR}/GIMP.app/Contents/Resources/Library/Frameworks/Python.framework/Versions/2.7/Resources/Python.app/Contents/Resources/" || exit 1
...
pushd ${PACKAGE_DIR}/GIMP.app/Contents/Resources/lib/gimp/2.0/plug-ins/Resources/lib || exit 1
