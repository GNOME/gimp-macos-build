...
ALTOOL_OUT="$(xcrun altool --notarize-app --file ${DMG_FILE} -u ${notarization_login} --primary-bundle-id org.gimp.gimp-2.99 -p ${notarization_password} 2>&1)" || ALTOOL_FAILED=true
